    ...
    <div className="flex h-screen flex-col bg-terminal-bg text-terminal-text">
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 lg:grid-cols-2">
          <button
            ...
            className="group rounded border border-terminal-border bg-terminal-panel p-5 text-left hover:border-terminal-accent"
          >
      ...
      <div className="border-t border-terminal-border bg-terminal-panel px-4 py-2 text-xs">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="ml-auto text-terminal-muted">Press E for Equity | F for F&O</span>
        </div>
      </div>
    </div>
  );
