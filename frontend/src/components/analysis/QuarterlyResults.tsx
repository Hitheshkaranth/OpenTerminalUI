      ...
      <div className="h-80 w-full">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={chartData}>
            ...
            <YAxis yAxisId="left" orientation="left" axisLine={false} tickLine={false} tick={{ fill: "#8e98a8", fontSize: 11 }} tickFormatter={(v) => `₹${(Number(v) / 10000000).toFixed(0)}Cr`} />
            ...
            <Bar yAxisId="left" dataKey="sales" name="Sales" fill="#ff9f1a" radius={[4, 4, 0, 0]} barSize={20} />
            <Bar yAxisId="left" dataKey="netProfit" name="Net Profit" fill="#00c176" radius={[4, 4, 0, 0]} barSize={20} />
